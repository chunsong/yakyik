...
var _store = __webpack_require__(/*! ./stores/store */ "./src/stores/store.js");
...
exports.default = function () {
    ...
    switch (action.type) {
        ...
        case _constants2.default.COMMENTS_CREATED:
            ...
            var commentList = updatedMap[action.comment.zone] ? Object.assign([], updatedMap[action.comment.zone]) : [];
...
var _zoneReducer = __webpack_require__(/*! ../reducers/zoneReducer */ "./src/reducers/zoneReducer.js");

var _zoneReducer2 = _interopRequireDefault(_zoneReducer);

var _commentReducer = __webpack_require__(/*! ../reducers/commentReducer */ "./src/reducers/commentReducer.js");
...
exports.default = {
    ...
    currentStore: function currentStore() {
        // returns the store from configureStore()
        return store;
    }
};
